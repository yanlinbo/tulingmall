...
public class UserController {
    ...
    @ResponseBody
    public CommonResult<UmsMember> register(@Validated @RequestBody UmsMember memberParam) {
        UmsMember umsMember = memberService.register(memberParam);
        if (umsMember == null) {
    ...
    @ResponseBody
    public CommonResult login(@Validated @RequestBody UmsMember memberParam) {
        UmsMember login = memberService.login(memberParam.getUsername(), memberParam.getPassword());
        if (login == null) {
